...
/* */
#[Route('/department/{nom}', name: 'app_salle_by_department', methods: ['GET'])]
    public function getByDepartment(string $nom, SalleRepository $salleRepository): Response
    {
        $salles = $salleRepository->findByNomdepart($nom);
